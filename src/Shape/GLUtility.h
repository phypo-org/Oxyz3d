...
namespace PP3d {
  ...
  public:
    ...
    static void DrawGrid( double iX, double iZ, float  pSz, int pNbDiv, float pWidth );
    ...
    static void DrawCursorCruz2( Point3d pPt, float pSz );
    static void DrawMinMaxBox(Rect3d&lMMb); 
    static void DrawRect(Rect3d&lMmb);
    static void DrawParralepipede(Rect3d&lMmb);
